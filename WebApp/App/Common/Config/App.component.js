...
(function () {
    ...
    angular.module('App')
      ...
      /*  .component('appmenuleft', {
            restrict: 'A',
            templateUrl: '/App/Components/MenuLeft/View/index.html',
            controller: ['$scope', 'MenuLeft', 'ngTranslations', function ($scope, MenuLeft, ngTranslations) {
                $scope.viewmodel = new MenuLeft();
                $scope.viewmodel.init();
                $scope.translation = ngTranslations.getTranslationObject();
            }]
        })  */     
